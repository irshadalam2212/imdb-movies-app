...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await axios(`${import.meta.env.VITE_PROD_URL}/movies/top250`)
      ...
      const highlightedMovie = moviesData.find(movie => {
        ...
        return votes > 25000 && rating > 8.0 && metascore > 80
      })
  ...
  return (
    <div className='home-container'>
      <div className='home-heading'>
        ...
        <br />
        <hr />
        <p>IMDb's Movie scrapes the <strong>TOP 250</strong> movies ranked by <a className='imdb-link' href="imdb.com">IMDb</a> and provides a unique and seemless way to find the right movie to watch! The data is regularly updated to ensure accurate ranking. Get creative with your entertainment choices by seeing the best movies to watch with a click of a button!</p>
        <br />
        <button>
