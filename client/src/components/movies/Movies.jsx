  ...
  return (
    <div className='movies-container'>
        <div className='movies-heading'>
            ...
            <hr />
            <p>
              Dive into the world of cinematic excellence with our curated list of the top 250 movies according to <a href="https://imdb.com">IMDb</a>, featuring an intuitive filter for personalized exploration. 
